...
public class Money implements Comparable<Money> {
	...
	public Boolean equals(Money other) {
		if (currency != other.getCurrency()){
			return (int)(amount/currency.getRate()) == (int)(other.getAmount() / other.getCurrency().getRate());
		}else{
	...
	public Money add(Money other) {
		double newAmount = 0;
		if(currency != other.getCurrency()){
			newAmount = (amount + other.amount/currency.getRate());
		}else{
			newAmount = amount + other.amount;
		}
	...
	public Money sub(Money other) {
		double newAmount = 0;
		if(currency != other.getCurrency()){
			newAmount = (int)(amount - other.amount/currency.getRate());
		}else{
			newAmount = amount - other.amount;
		}
		return new Money(newAmount, currency);
